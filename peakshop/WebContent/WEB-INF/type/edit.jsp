...
<div class="box-positon">
	<div class="rpos">当前位置: 商品类型管理 - 修改</div>
	<form class="ropt">
			...
			<tbody id="tab_1">
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="name" maxlength="100" size="100" value='${type.name}' id="typeName"/></td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					<span class="pn-frequired">*</span>
					...
					<td width="80%" class="pn-fcontent">
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl" src="${type.picture}"/>
							<input type="hidden" id="path" name="picture" value="${type.picture}"/>
