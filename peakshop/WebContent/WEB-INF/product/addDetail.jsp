...
function finishAddDetail(){    
	document.jvForm.action="finishAddDetail.do"; 
    document.jvForm.submit();       
 };
/* function continueAddDetail(){    
	document.jvForm.action="continueAddDetail.do"; 
    document.jvForm.submit();       
}; */
...
<div class="body-box" style="float:right">
	<form id="jvForm" action="" method="post" enctype="multipart/form-data" name="jvForm" onsubmit="return sbjvForm();">
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
					    <div class="div-image">
							...
							<input type="hidden" id="path1" name="picture1"/>
							<input type="file" onchange="uploadPic1()" name="file"/>
					    </div>
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl2"/>
							<input type="hidden" id="path2" name="picture2"/>
							<input type="file" onchange="uploadPic2()" name="file"/>
					    </div>
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl3"/>
							<input type="hidden" id="path3" name="picture3"/>
							<input type="file" onchange="uploadPic3()" name="file"/>
					    </div>
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl4"/>
							<input type="hidden" id="path4" name="picture4"/>
							<input type="file" onchange="uploadPic4()" name="file"/>
					    </div>
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl5"/>
							<input type="hidden" id="path5" name="picture5"/>
							<input type="file" onchange="uploadPic5()" name="file"/>
					    </div>
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl6"/>
							<input type="hidden" id="path6" name="picture6"/>
							<input type="file" onchange="uploadPic6()" name="file"/>
					    </div>
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl7"/>
							<input type="hidden" id="path6" name="picture7"/>
							<input type="file" onchange="uploadPic7()" name="file"/>
					    </div>
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl8"/>
							<input type="hidden" id="path6" name="picture8"/>
							<input type="file" onchange="uploadPic8()" name="file"/>
					    </div>
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl9"/>
							<input type="hidden" id="path6" name="picture9"/>
							<input type="file" onchange="uploadPic9()" name="file"/>
					    </div>
					    <div class="div-image">
					    	<img width="100" height="100" id="allUrl10"/>
							<input type="hidden" id="path6" name="picture10"/>
...
<!-- 						<input type="button" class="submit" value="继续" onclick="continueAddDetail()"/> &nbsp;  -->
						<input type="button" class="submit" value="完成" onclick="finishAddDetail()"/> &nbsp;
