...
<div class="box-positon">
	<div class="rpos">当前位置: 商家信息 - 修改</div>
	<div class="clear"></div>
</div>
<h2 class="h2_ch">
<span id="tabs">
			...
			<tbody id="tab_1">
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="address" maxlength="100" size="100" value='${merchantInfo.address}'/></td>
				</tr>
				
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						商家电话:</td><td width="80%" class="pn-fcontent">
						<input type="text" class="required" name="phone" maxlength="100" size="100" value='${merchantInfo.phone}'/></td>
				</tr>
				
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						商家微信:</td><td width="80%" class="pn-fcontent">
						<input type="text" class="required" name="weixin" maxlength="100" size="100" value='${merchantInfo.weixin}'/></td>
				</tr>
				
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						商家邮箱:</td><td width="80%" class="pn-fcontent">
						<input type="text" class="required" name="email" maxlength="100" size="100" value='${merchantInfo.email}'/></td>
				</tr>
				
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						商家QQ:</td><td width="80%" class="pn-fcontent">
						<input type="text" class="required" name="qq" maxlength="100" size="100" value='${merchantInfo.qq}'/></td>
				</tr>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="name" maxlength="100" size="100" value='${merchantInfo.name}' id="loginName"/></td>
				</tr>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="password" maxlength="100" size="100" value='${merchantInfo.password}' id="loginPassword"/></td>
				</tr>
