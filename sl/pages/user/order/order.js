...
Page({
  ...
  updateData: function () {
    ...
    wx.request({
      url: 'http://123.207.30.64:8080/Wxmini/order_getlist.do?typeId=' + typeId,
      // data: {},
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          ...
          wx.request({
            url: 'http://123.207.30.64:8080/Wxmini/order_cancel.do?id=' + id,
            // data: {},
            method: 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
            // header: {}, // 设置请求的 header
            success: function (res) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          ...
          wx.request({
            url: 'http://123.207.30.64:8080/Wxmini/order_del.do?id=' + id,
            // data: {},
            method: 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
            // header: {}, // 设置请求的 header
            success: function (res) {
  ...
  payOrder: function (e) {
    ...
    var that = this;
    wx.request({
      url: 'http://123.207.30.64:8080/Wxmini/order_pay.do?id=' + id,
      // data: {},
      method: 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
      // header: {}, // 设置请求的 header
      success: function (res) {
  ...
  confirmOrder: function (e) {
    ...
    var that = this;
    wx.request({
      url: 'http://123.207.30.64:8080/Wxmini/order_confirm.do?id=' + id,
      // data: {},
      method: 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
      // header: {}, // 设置请求的 header
      success: function (res) {
