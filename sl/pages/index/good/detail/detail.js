...
Page({
  ...
  onShow: function () {
    ...
    var that = this;
    wx.request({
      url: 'http://123.207.30.64:8080/Wxmini/good_get.do?id=' + id,
      // data: {},
  ...
  buyNow: function (e) {
    ...
    var that = this;
    wx.request({
      url: 'http://123.207.30.64:8080/Wxmini/good_buy.do?id=' + id + '&tc=' + tc,
      // data: {},
      method: 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
      // header: {}, // 设置请求的 header
      success: function (res) {
  ...
  addToCart: function (e) {
    ...
    var that = this;
    wx.request({
      url: 'http://123.207.30.64:8080/Wxmini/good_addToCart.do?id=' + id + '&tc=' + tc,
      // data: {},
      method: 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
      // header: {}, // 设置请求的 header
      success: function (res) {
